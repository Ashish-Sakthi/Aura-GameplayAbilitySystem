...
public:
	...
	/*
	 * Meta Attributes
	 * Instead of doing calculation on the health it calculate in the attribute set post effect . Gives flexibility.
	 */

	//Not replicated as Meta Attributes are only executed in the server.
